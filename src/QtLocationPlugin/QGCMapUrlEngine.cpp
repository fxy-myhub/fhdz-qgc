...
UrlFactory::UrlFactory() : _timeout(5 * 1000) {
    ...
    // ========== 高德地图 ==========
    _providersTable["GaoDe Street Map"] = new GaoDeStreetMapProvider(this);
    _providersTable["GaoDe Satellite"]  = new GaoDeSatelliteMapProvider(this);
    _providersTable["GaoDe Road Map"]   = new GaoDeRoadMapProvider(this);
    _providersTable["GaoDe Hybrid"]     = new GaoDeHybridMapProvider(this);
    ...
    // 天地图
    //_providersTable["Tianditu Satellite"]  = new TiandituSatelliteMapProvider(this);
    //_providersTable["Tianditu Annotation"] = new TiandituAnnotationMapProvider(this);
}
