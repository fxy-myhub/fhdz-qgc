...
class GaoDeStreetMapProvider : public MapProvider {
    Q_OBJECT
public:
    GaoDeStreetMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("https://webrd01.is.autonavi.com/appmaptile"), QStringLiteral("png"),
                      AVERAGE_TILE_SIZE, QGeoMapType::StreetMap, parent) {}

    QString _getURL(const int x, const int y, const int zoom, QNetworkAccessManager* networkManager) override;
};

class GaoDeSatelliteMapProvider : public MapProvider {
    Q_OBJECT
public:
    GaoDeSatelliteMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("https://webst01.is.autonavi.com/appmaptile"), QStringLiteral("jpg"),
                      AVERAGE_TILE_SIZE, QGeoMapType::SatelliteMapDay, parent) {}

    QString _getURL(const int x, const int y, const int zoom, QNetworkAccessManager* networkManager) override;
};

class GaoDeRoadMapProvider : public MapProvider {
    Q_OBJECT
public:
    GaoDeRoadMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("https://webst01.is.autonavi.com/appmaptile"), QStringLiteral("png"),
                      AVERAGE_TILE_SIZE, QGeoMapType::CustomMap, parent) {}

    QString _getURL(const int x, const int y, const int zoom, QNetworkAccessManager* networkManager) override;
};

class GaoDeHybridMapProvider : public MapProvider {
    Q_OBJECT
public:
    GaoDeHybridMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("https://webrd01.is.autonavi.com/appmaptile"), QStringLiteral("png"),
...
class TiandituSatelliteMapProvider : public MapProvider {
    Q_OBJECT
public:
    TiandituSatelliteMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("https://t0.tianditu.gov.cn"), QStringLiteral("jpg"),
                      AVERAGE_TILE_SIZE, QGeoMapType::SatelliteMapDay, parent) {}

    QString _getURL(const int x, const int y, const int zoom, QNetworkAccessManager* networkManager) override;
};

class TiandituAnnotationMapProvider : public MapProvider {
    Q_OBJECT
public:
    TiandituAnnotationMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("https://t0.tianditu.gov.cn"), QStringLiteral("png"),
                      AVERAGE_TILE_SIZE, QGeoMapType::CustomMap, parent) {}
