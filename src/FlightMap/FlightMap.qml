...
Map {
    ...
    gesture.acceptedGestures:   MapGestureArea.PinchGesture | (allowPanGesture ? (MapGestureArea.PanGesture | MapGestureArea.FlickGesture) : 0)
    ...
    property bool   allowPanGesture:                 true    ///< true: pan and flick gestures are enabled
    ...
    MapQuickItem {
        ...
        sourceItem: Image {
            id:             mapItemImage
            source:         isNaN(gcsHeading) ? "/res/fenghua.png" : "/res/QGCLogoArrow"
            mipmap:         true
            antialiasing:   true
